...
var fileDescriptor_c4f917211a932270 = []byte{
	...
	0x62, 0x1a, 0xc1, 0x2c, 0x0f, 0x4e, 0x2d, 0x2a, 0xcb, 0x4c, 0x4e, 0x15, 0x32, 0xe3, 0xe2, 0x75,
	0xce, 0x48, 0x4d, 0xce, 0x86, 0x99, 0x2a, 0x24, 0xa0, 0x57, 0x90, 0xa4, 0x87, 0xec, 0x3e, 0x29,
	0x41, 0x24, 0x11, 0x88, 0x4d, 0x4a, 0x0c, 0x4e, 0xdc, 0x51, 0x9c, 0x7a, 0xfa, 0x05, 0x49, 0xd9,
	0xd6, 0x45, 0x05, 0xc9, 0x49, 0x6c, 0x60, 0xcf, 0x19, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x22,
	0xbf, 0x44, 0xd7, 0xed, 0x00, 0x00, 0x00,
}
...
func (c *loginServiceClient) CheckPassword(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	out := new(LoginResponse)
	err := c.cc.Invoke(ctx, "/pb.LoginService/CheckPassword", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedLoginServiceServer) CheckPassword(ctx context.Context, req *LoginRequest) (*LoginResponse, error) {
...
func _LoginService_CheckPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LoginServiceServer).CheckPassword(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.LoginService/CheckPassword",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoginServiceServer).CheckPassword(ctx, req.(*LoginRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _LoginService_CheckPassword_Handler,
		},
	},
